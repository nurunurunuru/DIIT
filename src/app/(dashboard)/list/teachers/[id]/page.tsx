...
import Saidur from "../../../../../../public/saidur.png"
...
const SingleTeacherPage = async  ({
  ...
  const authData = await auth(); // Await the async auth function
    const sessionClaims = authData.sessionClaims; // Extract sessionClaims from auth data
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Saidur Rahman</h1>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">{teacher._count.lessons}</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
